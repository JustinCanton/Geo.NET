...
namespace Geo.Here.Tests.Converters
{
    ...
    public class AutosuggestJsonConverterShould
    {
        ...
        {
            var obj = JsonSerializer.Deserialize<AutosuggestObject>("{\"Autosuggest\":{\"href\":\"Query href\",\"title\":\"A query title\",\"id\":\"12345\"}}");
        ...
        /// </summary>
        [Fact]
        public void CorrectlyParseAutosuggestEntityLocation()
        {
            var obj = JsonSerializer.Deserialize<AutosuggestObject>("{\"Autosuggest\":{\"distance\":123,\"address\":{\"label\":\"An entity label\",\"countryName\":\"EntityLand\"},\"title\":\"An entity title\",\"id\":\"67890\"}}");
