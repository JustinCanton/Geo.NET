...
namespace Geo.Google
{
    ...
    internal static class LoggerExtensions
    {
        private static readonly Action<ILogger, string, Exception> _error = LoggerMessage.Define<string>(
            LogLevel.Error,
            new EventId(1, nameof(GoogleGeocoding)),
            "GoogleGeocoding: {ErrorMessage}");

        private static readonly Action<ILogger, string, Exception> _warning = LoggerMessage.Define<string>(
            LogLevel.Warning,
            new EventId(2, nameof(GoogleGeocoding)),
            "GoogleGeocoding: {WarningMessage}");

        private static readonly Action<ILogger, string, Exception> _debug = LoggerMessage.Define<string>(
            LogLevel.Debug,
            new EventId(3, nameof(GoogleGeocoding)),
            "GoogleGeocoding: {DebugMessage}");
        ...
        public static void GoogleError(this ILogger logger, string errorMessage)
        {
        ...
        public static void GoogleWarning(this ILogger logger, string warningMessage)
        {
        ...
        public static void GoogleDebug(this ILogger logger, string debugMessage)
        {
