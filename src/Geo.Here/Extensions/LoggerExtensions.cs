...
namespace Geo.Here
{
    ...
    internal static class LoggerExtensions
    {
        private static readonly Action<ILogger, string, Exception> _error = LoggerMessage.Define<string>(
            LogLevel.Error,
            new EventId(1, nameof(HereGeocoding)),
            "HereGeocoding: {ErrorMessage}");

        private static readonly Action<ILogger, string, Exception> _warning = LoggerMessage.Define<string>(
            LogLevel.Warning,
            new EventId(2, nameof(HereGeocoding)),
            "HereGeocoding: {WarningMessage}");

        private static readonly Action<ILogger, string, Exception> _debug = LoggerMessage.Define<string>(
            LogLevel.Debug,
            new EventId(3, nameof(HereGeocoding)),
            "HereGeocoding: {DebugMessage}");
        ...
        public static void HereError(this ILogger logger, string errorMessage)
        {
        ...
        public static void HereWarning(this ILogger logger, string warningMessage)
        {
        ...
        public static void HereDebug(this ILogger logger, string debugMessage)
        {
