...
namespace Geo.Geoapify
{
    ...
    internal static class LoggerExtensions
    {
        private static readonly Action<ILogger, string, Exception> _error = LoggerMessage.Define<string>(
            LogLevel.Error,
            new EventId(1, nameof(GeoapifyGeocoding)),
            "GeoapifyGeocoding: {ErrorMessage}");

        private static readonly Action<ILogger, string, Exception> _warning = LoggerMessage.Define<string>(
            LogLevel.Warning,
            new EventId(2, nameof(GeoapifyGeocoding)),
            "GeoapifyGeocoding: {WarningMessage}");

        private static readonly Action<ILogger, string, Exception> _debug = LoggerMessage.Define<string>(
            LogLevel.Debug,
            new EventId(3, nameof(GeoapifyGeocoding)),
            "GeoapifyGeocoding: {DebugMessage}");
        ...
        public static void GeoapifyError(this ILogger logger, string errorMessage)
        {
        ...
        public static void GeoapifyWarning(this ILogger logger, string warningMessage)
        {
        ...
        public static void GeoapifyDebug(this ILogger logger, string debugMessage)
        {
