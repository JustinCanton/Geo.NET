...
namespace Geo.Geoapify.Models
{
    ...
    public class Coordinate
    {
        ...
        /// <summary>
        /// Returns the coordinate in the Geoapify longitude first format.
        /// </summary>
        /// <returns>A <see cref="string"/> in the format "longitude,latitude".</returns>
