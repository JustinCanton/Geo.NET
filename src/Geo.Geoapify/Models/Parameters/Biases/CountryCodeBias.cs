// <copyright file="CountryCodeBias.cs" company="Geo.NET">
// Copyright (c) Geo.NET.
...
namespace Geo.Geoapify.Models.Parameters.Biases
{
    ...
    /// <summary>
    /// A bias preferring results from one or more countries.
    /// </summary>
    public class CountryCodeBias : Bias
    {
        /// <summary>
        /// Gets the ISO 3166-1 alpha-2 country codes to prefer results from.
