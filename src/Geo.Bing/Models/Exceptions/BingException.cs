// <copyright file="BingException.cs" company="Geo.NET">
// Copyright (c) Geo.NET.
// Licensed under the MIT license. See the LICENSE file in the solution root for full license information.
// </copyright>

namespace Geo.Bing.Models.Exceptions
{
    using System;
    ...
    /// <summary>
    /// A wrapper exception for any exceptions thrown in the Bing functionality. The current exceptions wrapped by this exception are listed.
    /// </summary>
    ...
    public class BingException : GeoCoreException
    {
        ...
        public BingException(string message, Exception inner)
