...
namespace Geo.Nominatim
{
    ...
    internal static class LoggerExtensions
    {
        private static readonly Action<ILogger, string, Exception> _error = LoggerMessage.Define<string>(
            LogLevel.Error,
            new EventId(1, nameof(NominatimGeocoding)),
            "NominatimGeocoding: {ErrorMessage}");

        private static readonly Action<ILogger, string, Exception> _warning = LoggerMessage.Define<string>(
            LogLevel.Warning,
            new EventId(2, nameof(NominatimGeocoding)),
            "NominatimGeocoding: {WarningMessage}");

        private static readonly Action<ILogger, string, Exception> _debug = LoggerMessage.Define<string>(
            LogLevel.Debug,
            new EventId(3, nameof(NominatimGeocoding)),
            "NominatimGeocoding: {DebugMessage}");
        ...
        public static void NominatimError(this ILogger logger, string errorMessage)
        {
        ...
        public static void NominatimWarning(this ILogger logger, string warningMessage)
        {
        ...
        public static void NominatimDebug(this ILogger logger, string debugMessage)
        {
