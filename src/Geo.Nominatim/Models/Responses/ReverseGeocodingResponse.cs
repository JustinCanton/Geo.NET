...
namespace Geo.Nominatim.Models.Responses
{
    ...
    /// <summary>
    /// The response from a Nominatim reverse geocoding request.
    /// </summary>
    public class ReverseGeocodingResponse
    {
        ...
        /// <summary>
        /// Gets or sets the geometry of the place in GeoJSON format when requested.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the geometry as WKT when requested.
        /// </summary>
